...
The \texttt{BoxIn} class is the main window. The majority of setup for this window is done in a \texttt{.ui} file generated using Qt Creator. All other sub-components found in this window should also have this window as a parent window. This class inherits from \texttt{QWidget}. The \texttt{BoxIn} class mainly acts as a container for most of the GUI components\\
